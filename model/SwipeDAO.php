...
class SwipeDAO {
    ...
    /**
    * funcao para criar swipe
     */
    function criarSwipe($id_usuario, $id_receita, $status){
        global $pdo;
        try {

            $sql = "INSERT IGNORE INTO swipe (id_usuario, id_receita, status) VALUES (?, ?, ?)";
            $stmt = $pdo->prepare($sql);
            ...
            error_log("Erro ao criar swipe: " . $e->getMessage());
            return false;
        }
    }
}
